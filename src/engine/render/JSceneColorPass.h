...
private:
	void renderDrawItems(const JRenderPassContext& context, const JFrameDesc& frameDesc, JArrayView<const uint32> drawItemIndices, D3D12_GPU_VIRTUAL_ADDRESS cameraGpuAddress, D3D12_GPU_VIRTUAL_ADDRESS lightGpuAddress);
