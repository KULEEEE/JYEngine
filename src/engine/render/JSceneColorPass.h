...
private:
	void RenderDrawItems(const JRenderPassContext& context, const std::vector<JDrawItem>& drawItems);
	void RenderDrawItem(const JRenderPassContext& context, const JDrawItem& drawItem);
